...
<?php foreach ($schemaMigrations as $schemaMigration): ?>
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $schemaMigration['SchemaMigration']['id']), array('class' => 'btn btn-default btn-xs')); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $schemaMigration['SchemaMigration']['id']), array('class' => 'btn btn-default btn-xs')); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $schemaMigration['SchemaMigration']['id']), array('class' => 'btn btn-default btn-xs'), __('Are you sure you want to delete # %s?', $schemaMigration['SchemaMigration']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
					</tbody>

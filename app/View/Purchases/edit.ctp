...
<div id="page-container" class="row">
	...
	<div id="sidebar" class="col-sm-3">
		...
		<div class="actions">
			...
			<ul class="list-group">
				<li class="list-group-item"><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Purchase.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Purchase.id'))); ?></li>
				<li class="list-group-item"><?php echo $this->Html->link(__('List Purchases'), array('action' => 'index')); ?></li>
	...
	<div id="page-content" class="col-sm-9">
		...
		<h2><?php echo __('Edit Purchase'); ?></h2>
		...
		<div class="purchases form">
			...
			<?php echo $this->Form->create('Purchase', array('role' => 'form')); ?>
				...
				<fieldset>
					...
					<div class="form-group">
						<?php echo $this->Form->input('spend', array('class' => 'form-control')); ?>
					</div><!-- .form-group -->
